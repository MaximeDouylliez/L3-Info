...
// on a défini tous les mot-clés qui sont prioritaire sur les identificateurs :
// on définit donc maintenant seulement les identificateurs. C'est ainsi que sont
// gérées les priorités en JFlex: les règles lexicales vont du plus au moins prioritaire 
// ("le premier return gagne").
...
// si on tombe dans cette règle c'est qu'aucun token n'a pu être reconnu
// dans le flot d'entrée : il y a erreur lexicale
